...
var _extends4 = __webpack_require__(212);

var _extends5 = _interopRequireDefault(_extends4);

exports.default = annotations;

var _testAnnotations = __webpack_require__(345);
...
function annotation(state, action) {
  switch (action.type) {
    case _constants2.default:
      return (0, _extends5.default)({}, state, (0, _defineProperty3.default)({}, action.fieldName, action.value));
    default:
      return state;
  }
}
...
function annotations() {
  ...
  switch (action.type) {
    case _constants2.default:
      return (0, _extends5.default)({}, state, (0, _defineProperty3.default)({}, action.annotationName, annotation(state[action.annotationName])));
    default:
      return state;
  }
}
...
var _annotations = __webpack_require__(201);

var _annotations2 = _interopRequireDefault(_annotations);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var store = (0, _redux.createStore)(_annotations2.default); /* global chrome */

(0, _reactChromeRedux.wrapStore)(store, { portName: 'TENT' });
...
$export($export.S + $export.F * !__webpack_require__(14), 'Object', {defineProperty: __webpack_require__(61).f});
