...
exports.currentFieldTypeSelector = exports.mappingsSelector = exports.schemaSelector = undefined;

var _lodash = __webpack_require__(161);

var _lodash2 = _interopRequireDefault(_lodash);

var _reselect = __webpack_require__(222);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var schemaSelector = exports.schemaSelector = function schemaSelector(state) {
  return state.schema;
};
var mappingsSelector = exports.mappingsSelector = function mappingsSelector(state) {
  return state.mappings;
};

var currentFieldTypeSelector = exports.currentFieldTypeSelector = (0, _reselect.createSelector)(schemaSelector, function (state) {
  return state.currentAnnotation;
}, function (state) {
  return state.currentField;
}, function (schemas, currentAnnotation, currentField) {
  return (0, _lodash2.default)(schemas, [currentAnnotation, 'fields', currentField]);
});
...
var _testAnnotations = __webpack_require__(485);
...
exports.default = (_LOAD_ANNOTATIONS_PRO = {}, (0, _defineProperty3.default)(_LOAD_ANNOTATIONS_PRO, _constants.LOAD_ANNOTATIONS_PROXY, function () {
  return {
    type: _constants.LOAD_ANNOTATIONS,
    payload: _config.getEndpoint ? _superagent2.default.get(_config.getEndpoint) : _promise2.default.resolve(_testAnnotations2.default)
  };
  ...
  return function (dispatch, getState) {
    return {
      ...
      payload: _config.postEndpoint ? _superagent2.default.post(_config.postEndpoint).send(getState().mappings) : _promise2.default.resolve()
    };
  };
...
var _extends5 = __webpack_require__(64);
...
function main() {
  ...
  switch (action.type) {
    case _constants.ADD_COLLECTION_MAPPING:
      {
        return (0, _extends6.default)({}, state, {
          mappings: (0, _extends6.default)({}, state.mappings, (0, _defineProperty3.default)({}, action.annotationName, (0, _annotatedItem2.default)(state.mappings[action.annotationName], (0, _extends6.default)({}, action, {
            schema: (0, _selectors.schemaSelector)(state)[action.annotationName]
          }))))
        });
      }
    ...
    case _constants.LOAD_ANNOTATIONS:
      {
        return {
          schema: action.payload,
          mappings: (0, _lodash2.default)(action.payload, function (annotationInfo) {
...
var _fluxStandardAction = __webpack_require__(349);
...
var _reduxPromise = __webpack_require__(282);
...
var _reactChromeRedux = __webpack_require__(117);

var _aliases = __webpack_require__(276);
...
var store = (0, _redux.createStore)(_main2.default, (0, _redux.applyMiddleware)((0, _reactChromeRedux.alias)(_aliases2.default), _reduxThunk2.default, _reduxPromise2.default)); /* global chrome */
...
var getEndpoint = exports.getEndpoint = null;
var postEndpoint = exports.postEndpoint = null;
...
var _extends3 = __webpack_require__(64);
...
var shouldRetry = __webpack_require__(479);
