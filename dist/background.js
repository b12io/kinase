...
function selectElement(selector, content) {
  return {
    selector: selector,
    content: content,
    type: _constants.SELECT_ELEMENT
  };
}
...
var _wrapStore = __webpack_require__(196);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16), __webpack_require__(21)(module)))
...
var _proxyActions = __webpack_require__(62);
...
var _extends5 = __webpack_require__(63);
...
var _testAnnotations = __webpack_require__(463);

var _testAnnotations2 = _interopRequireDefault(_testAnnotations);

var _annotatedItem = __webpack_require__(282);
...
var initialState = {
  schema: _testAnnotations2.default,
  mappings: (0, _lodash2.default)(_testAnnotations2.default, function (annotationName, annotationInfo) {
    return (0, _annotatedItem2.default)(undefined, {
...
function main() {
  ...
  switch (action.type) {
    case _constants.ADD_COLLECTION_MAPPING:
      {
        return (0, _extends6.default)({}, state, {
          mappings: (0, _extends6.default)({}, state.mappings, (0, _defineProperty3.default)({}, action.annotationName, (0, _annotatedItem2.default)(state.mappings[action.annotationName], (0, _extends6.default)({}, action, {
    ...
    case _constants.DELETE_COLLECTION_MAPPING:
      {
        return (0, _extends6.default)({}, state, {
          mappings: (0, _extends6.default)({}, state.mappings, (0, _defineProperty3.default)({}, action.annotationName, (0, _annotatedItem2.default)(state.mappings[action.annotationName], action)))
        });
      }
...
var _aliases = __webpack_require__(270);
...
var store = (0, _redux.createStore)(_main2.default, (0, _redux.applyMiddleware)((0, _reactChromeRedux.alias)(_aliases2.default), _reduxThunk2.default));
...
var _toConsumableArray2 = __webpack_require__(289);
...
var _lodash5 = __webpack_require__(108);

var _lodash6 = _interopRequireDefault(_lodash5);

var _annotatedItemField = __webpack_require__(283);
...
function annotatedItem(state, action) {
  var newMapping = function newMapping() {
    return (0, _lodash6.default)(action.schema.fields, function () {
  ...
  switch (action.type) {
    case _constants.ADD_COLLECTION_MAPPING:
      {
        return [].concat((0, _toConsumableArray3.default)(state), [newMapping()]);
      }
    case _constants.DELETE_COLLECTION_MAPPING:
      {
    ...
    case _constants.UPDATE_FIELD:
      {
        ...
        _newState[action.collectionIndex] = (0, _extends4.default)({}, state, (0, _defineProperty3.default)({}, action.fieldName, (0, _annotatedItemField2.default)(state[action.collectionIndex][action.fieldName], action)));
        return _newState;
      }
    default:
      {
...
function annotatedItemField(state, action) {
