...
exports.UPDATE_FIELD_PROXY = exports.UPDATE_FIELD = exports.SET_CURRENT_FIELD = exports.SET_CONTEXT_KEY = exports.SET_EXPANDED_PROXY = exports.SET_EXPANDED = exports.SET_ACTIVE_PROXY = exports.SET_ACTIVE = exports.SELECT_ELEMENT_PROXY = exports.SAVE_ANNOTATED_ITEMS_PROXY = exports.SAVE_ANNOTATED_ITEMS = exports.LOAD_ANNOTATIONS_PROXY = exports.LOAD_ANNOTATIONS = exports.DELETE_COLLECTION_MAPPING = exports.CLEAR_ERROR = exports.ADD_COLLECTION_MAPPING = exports.PORT_NAME = undefined;

var _promiseHelpers = __webpack_require__(79);

var PORT_NAME = exports.PORT_NAME = 'TENT';

var ADD_COLLECTION_MAPPING = exports.ADD_COLLECTION_MAPPING = 'ADD_COLLECTION_MAPPING';
var CLEAR_ERROR = exports.CLEAR_ERROR = 'CLEAR_ERROR';
var DELETE_COLLECTION_MAPPING = exports.DELETE_COLLECTION_MAPPING = 'DELETE_COLLECTION_MAPPING';
var LOAD_ANNOTATIONS = exports.LOAD_ANNOTATIONS = (0, _promiseHelpers.promiseActionTypes)('LOAD_ANNOTATIONS');
var LOAD_ANNOTATIONS_PROXY = exports.LOAD_ANNOTATIONS_PROXY = 'LOAD_ANNOTATIONS_PROXY';
var SAVE_ANNOTATED_ITEMS = exports.SAVE_ANNOTATED_ITEMS = (0, _promiseHelpers.promiseActionTypes)('SAVE_ANNOTATED_ITEMS');
var SAVE_ANNOTATED_ITEMS_PROXY = exports.SAVE_ANNOTATED_ITEMS_PROXY = 'SAVE_ANNOTATED_ITEMS_PROXY';
var SELECT_ELEMENT_PROXY = exports.SELECT_ELEMENT_PROXY = 'SELECT_ELEMENT_PROXY';
var SET_ACTIVE = exports.SET_ACTIVE = 'SET_ACTIVE';
var SET_ACTIVE_PROXY = exports.SET_ACTIVE_PROXY = 'SET_ACTIVE_PROXY';
var SET_EXPANDED = exports.SET_EXPANDED = 'SET_EXPANDED';
var SET_EXPANDED_PROXY = exports.SET_EXPANDED_PROXY = 'SET_EXPANDED_PROXY';
var SET_CONTEXT_KEY = exports.SET_CONTEXT_KEY = 'SET_CONTEXT_KEY';
var SET_CURRENT_FIELD = exports.SET_CURRENT_FIELD = 'SET_CURRENT_FIELD';
var UPDATE_FIELD = exports.UPDATE_FIELD = 'UPDATE_FIELD';
var UPDATE_FIELD_PROXY = exports.UPDATE_FIELD_PROXY = 'UPDATE_FIELD_PROXY';
...
exports.addCollectionMapping = addCollectionMapping;
exports.clearError = clearError;
exports.deleteCollectionMapping = deleteCollectionMapping;
exports.loadAnnotations = loadAnnotations;
exports.saveAnnotatedItems = saveAnnotatedItems;
...
function addCollectionMapping(annotationName) {
  return {
...
function deleteCollectionMapping(annotationName, collectionIndex) {
  return {
    annotationName: annotationName,
    collectionIndex: collectionIndex,
    type: _constants.DELETE_COLLECTION_MAPPING
  };
}

function loadAnnotations() {
  return {
    type: _constants.LOAD_ANNOTATIONS_PROXY
  };
}

function saveAnnotatedItems() {
  return {
    type: _constants.SAVE_ANNOTATED_ITEMS_PROXY
  };
}

function selectElement(selector, content) {
...
function setActive(active) {
  return {
    active: active,
    type: _constants.SET_ACTIVE_PROXY
  };
}

function setContextKey(contextKey) {
  return {
    contextKey: contextKey,
    type: _constants.SET_CONTEXT_KEY
  };
}

function setCurrentField(annotationName, collectionIndex, fieldName) {
  return {
    annotationName: annotationName,
    collectionIndex: collectionIndex,
    fieldName: fieldName,
    type: _constants.SET_CURRENT_FIELD
  };
}
...
function setExpanded(expanded) {
  return {
    expanded: expanded,
    type: _constants.SET_EXPANDED_PROXY
  };
}

function updateField(annotationName, collectionIndex, fieldName, mapping) {
  ...
  return {
    ...
    mapping: mapping,
    append: append,
    type: _constants.UPDATE_FIELD_PROXY
  };
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_symbol_observable__ = __webpack_require__(186);
...
exports.isRejected = exports.promiseActionTypes = exports.promiseTypeSuffixes = undefined;
...
var promiseTypeSuffixes = exports.promiseTypeSuffixes = ['PENDING', 'FULFILLED', 'REJECTED'];
...
var promiseActionTypes = exports.promiseActionTypes = function promiseActionTypes(baseType) {
  return (0, _extends3.default)({}, (0, _lodash4.default)(promiseTypes, function (suffix) {
...
var isRejected = exports.isRejected = function isRejected(action) {
  return (0, _lodash2.default)(action.type, promiseTypes.REJECTED);
};
...
var _wrapStore = __webpack_require__(163);

var _wrapStore2 = _interopRequireDefault(_wrapStore);

var _alias = __webpack_require__(161);
...
var _assignIn = __webpack_require__(151);
...
var _lodash3 = __webpack_require__(304);

var _lodash4 = _interopRequireDefault(_lodash3);

var _lodash5 = __webpack_require__(305);

var _lodash6 = _interopRequireDefault(_lodash5);

var _api = __webpack_require__(244);

var _proxyActions = __webpack_require__(37);
...
exports.default = (_LOAD_ANNOTATIONS_PRO = {}, (0, _defineProperty3.default)(_LOAD_ANNOTATIONS_PRO, _constants.LOAD_ANNOTATIONS_PROXY, function () {
  ...
  return function (dispatch, getState) {
    var _getState = getState(),
        currentAnnotation = _getState.currentAnnotation,
        currentIndex = _getState.currentIndex,
...
}), (0, _defineProperty3.default)(_LOAD_ANNOTATIONS_PRO, _constants.SET_ACTIVE_PROXY, function (action) {
  return function (dispatch) {
    dispatch((0, _proxyActions.setCurrentField)());
    return dispatch((0, _extends3.default)({}, action, {
      type: _constants.SET_ACTIVE
    }));
  };
}), (0, _defineProperty3.default)(_LOAD_ANNOTATIONS_PRO, _constants.SET_EXPANDED_PROXY, function (action) {
  return function (dispatch) {
    dispatch((0, _proxyActions.setCurrentField)());
    return dispatch((0, _extends3.default)({}, action, {
      type: _constants.SET_EXPANDED
    }));
  };
}), (0, _defineProperty3.default)(_LOAD_ANNOTATIONS_PRO, _constants.UPDATE_FIELD_PROXY, function (action) {
  return function (dispatch, getState) {
    var currentMapping = (0, _selectors.currentContextSelector)(getState())[action.annotationName].collectionMappings[action.collectionIndex][action.fieldName];
    if (!(0, _lodash2.default)(action.mapping, (0, _lodash6.default)(currentMapping, (0, _keys2.default)(action.mapping)))) {
...
var _annotationContext = __webpack_require__(248);

var _annotationContext2 = _interopRequireDefault(_annotationContext);
...
var defaultContextKey = '__default';
...
function main() {
  ...
  if ((0, _promiseHelpers.isRejected)(action)) {
  ...
  switch (action.type) {
    ...
    case _constants.LOAD_ANNOTATIONS.FULFILLED:
      {
        return (0, _extends6.default)({}, state, {
          ready: true,
          contexts: (0, _lodash2.default)(state.contexts, function (context) {
            return (0, _annotationContext2.default)(context, action);
          })
        });
      }
    case _constants.SAVE_ANNOTATED_ITEMS.PENDING:
      {
        return (0, _extends6.default)({}, state, {
          saving: true
        });
      }
    case _constants.SAVE_ANNOTATED_ITEMS.FULFILLED:
      {
        return (0, _extends6.default)({}, state, {
          saving: false
        });
      }
    case _constants.SET_ACTIVE:
      {
        return (0, _extends6.default)({}, state, {
    ...
    case _constants.SET_EXPANDED:
      {
        return (0, _extends6.default)({}, state, {
          expanded: action.expanded
        });
      }
    case _constants.SET_CONTEXT_KEY:
      {
        return (0, _extends6.default)({}, state, {
          contexts: (0, _extends6.default)({}, state.contexts, (0, _defineProperty3.default)({}, action.contextKey, (0, _annotationContext2.default)(state.contexts[action.contextKey], action))),
    ...
    case _constants.SET_CURRENT_FIELD:
      {
        return (0, _extends6.default)({}, state, {
    ...
    case _constants.ADD_COLLECTION_MAPPING:
      return (0, _extends6.default)({}, state, {
        contexts: (0, _extends6.default)({}, state.contexts, (0, _defineProperty3.default)({}, state.currentContextKey, (0, _annotationContext2.default)(state.contexts[state.currentContextKey], action)))
      });
    case _constants.DELETE_COLLECTION_MAPPING:
...
var _isPromise = __webpack_require__(399);
...
var _testAnnotations = __webpack_require__(402);
...
var _reduxPromiseMiddleware = __webpack_require__(241);
...
var _aliases = __webpack_require__(236);
...
var store = (0, _redux.createStore)(_main2.default, (0, _redux.applyMiddleware)((0, _reactChromeRedux.alias)(_aliases2.default), _reduxThunk2.default, (0, _reduxPromiseMiddleware2.default)({
  promiseTypeSuffixes: _constants.promiseTypeSuffixes
})));
(0, _reactChromeRedux.wrapStore)(store, { portName: _constants.PORT_NAME });
exports.default = store;


chrome.runtime.onMessageExternal.addListener(function (request) {
  if (request.data.contextKey) {
    store.dispatch((0, _proxyActions.setContextKey)(request.data.contextKey));
  }
});
...
chrome.browserAction.onClicked.addListener(function () {
  var active = store.getState().active;
  store.dispatch((0, _proxyActions.setActive)(!active));

  var tabCallback = void 0;
  if (active) {
    // Tear down extension on all tabs
    tabCallback = function tabCallback(tab) {
      return tearDown(tab.id);
    };
...
exports.annotatedItemType = undefined;
...
var _annotatedItemField = __webpack_require__(247);
...
var annotatedItemType = exports.annotatedItemType = _propTypes2.default.shape({
  updated: _propTypes2.default.bool,
  schema: _propTypes2.default.shape({
    multiple: _propTypes2.default.bool,
    fields: _propTypes2.default.objectOf(_propTypes2.default.string).isRequired
  }).isRequired,
  collectionMappings: _propTypes2.default.arrayOf(_propTypes2.default.objectOf(_annotatedItemField.annotatedItemFieldType)).isRequired
});
...
function annotatedItem(state, action) {
  ...
  switch (action.type) {
    ...
    case _constants.ADD_COLLECTION_MAPPING:
      {
        return (0, _extends4.default)({}, state, {
          updated: true,
          collectionMappings: [].concat((0, _toConsumableArray3.default)(state.collectionMappings), [newCollectionMapping()])
        });
      }
    ...
    case _constants.DELETE_COLLECTION_MAPPING:
      {
        ...
        return (0, _extends4.default)({}, newState, {
          updated: true
        });
      }
    ...
    case _constants.UPDATE_FIELD:
      {
        var _newState = (0, _lodash2.default)(state);
        _newState.collectionMappings[action.collectionIndex] = (0, _extends4.default)({}, state.collectionMappings[action.collectionIndex], (0, _defineProperty3.default)({}, action.fieldName, (0, _annotatedItemField2.default)(state.collectionMappings[action.collectionIndex][action.fieldName], action)));
        return (0, _extends4.default)({}, _newState, {
          updated: true
        });
      }
...
exports.annotatedItemFieldType = undefined;
...
exports.default = annotatedItemField;
...
function annotatedItemField() {
  ...
  switch (action.type) {
    case _constants.LOAD_ANNOTATIONS.FULFILLED:
      return (0, _lodash2.default)(state, initialState);
    case _constants.UPDATE_FIELD:
      if (action.append) {
...
exports.annotationContextType = undefined;
...
var _annotatedItem = __webpack_require__(246);
...
var annotationContextType = exports.annotationContextType = _propTypes2.default.objectOf(_annotatedItem.annotatedItemType);

function annotationContext(state, action) {
  switch (action.type) {
    case _constants.LOAD_ANNOTATIONS.FULFILLED:
      {
        return (0, _lodash4.default)(action.payload.schema, function (schema, name) {
          // Get data already mapped, if any
          if ((0, _lodash2.default)(state)) {
            // State is being loaded for the first time
            return (0, _annotatedItem2.default)({
              schema: schema,
              collectionMappings: action.payload.mappings[name]
            }, action);
          }
          // Ensure annotations are only those found in the new schema
          return (0, _annotatedItem2.default)((0, _extends4.default)({}, state[name], { schema: schema }), action);
        });
      }
    ...
    case _constants.UPDATE_FIELD:
      {
        return (0, _extends4.default)({}, state, (0, _defineProperty3.default)({}, action.annotationName, (0, _annotatedItem2.default)(state[action.annotationName], action)));
      }
...
var _lodash5 = __webpack_require__(306);

var _lodash6 = _interopRequireDefault(_lodash5);

var _reselect = __webpack_require__(400);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var annotationContextsSelector = exports.annotationContextsSelector = function annotationContextsSelector(state) {
  return state.contexts;
};
var currentAnnotationSelector = exports.currentAnnotationSelector = function currentAnnotationSelector(state) {
  return state.currentAnnotation;
};
var currentIndexSelector = exports.currentIndexSelector = function currentIndexSelector(state) {
  return state.currentIndex;
};
var currentFieldSelector = exports.currentFieldSelector = function currentFieldSelector(state) {
  return state.currentField;
};
var readySelector = exports.readySelector = function readySelector(state) {
  return state.ready;
};

var currentContextKeySelector = exports.currentContextKeySelector = function currentContextKeySelector(state) {
  return state.currentContextKey;
};

var currentContextSelector = exports.currentContextSelector = (0, _reselect.createSelector)(annotationContextsSelector, currentContextKeySelector, function (contexts, currentContextKey) {
  return (0, _lodash2.default)(contexts, currentContextKey);
});

var currentAnnotatedItemSelector = exports.currentAnnotatedItemSelector = (0, _reselect.createSelector)(currentContextSelector, currentAnnotationSelector, function (context, annotationName) {
  return context[annotationName];
});

var currentFieldTypeSelector = exports.currentFieldTypeSelector = (0, _reselect.createSelector)(currentAnnotatedItemSelector, currentFieldSelector, function (currentAnnotatedItem, currentField) {
...
var currentMappingsSelector = exports.currentMappingsSelector = (0, _reselect.createSelector)(currentContextSelector, function (context) {
  return (0, _lodash4.default)((0, _lodash6.default)(context, function (annotatedItem) {
    ...
    return annotatedItem.collectionMappings;
  });
});
...
__webpack_require__(25)(IteratorPrototype, __webpack_require__(14)('iterator'), function(){ return this; });
...
$export($export.S + $export.F * !__webpack_require__(16), 'Object', {defineProperty: __webpack_require__(27).f});
